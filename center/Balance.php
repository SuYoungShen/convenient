...
//   var_dump($BDatetime);echo "<br/>";
// var_dump($DDatetime);
// array_push(array_search(implode(array_diff($BDatetime,$DDatetime)),$DDatetime),0);
  // for ($i=0; $i < count($ShowBC); $i++) {
  //
  //   // if ($BDatetime[$i] != $DDatetime[$i]) {
  //   //   echo array_push($DDatetime[$i],0);
  //   // }
  //
  //   echo "
  //     <tr>
